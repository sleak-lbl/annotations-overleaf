...
\RED{Note to Steve: did you want to do a display of annotation occurences?
If so, the output files from some of the queries are int he output directory or
I can gin up some other cases to display.}
